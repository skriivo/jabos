...
# Enable SSL/TLS downgrade protection (ScsvForTls)
...
Write-Host 'Signalling Cipher Suite Value has been enabled'
...
Write-Host "Disabled MD5 Hashes"
...
Write-Host "KeyExchangeAlgorithm has been enabled"
...
Write-Host "Cipher suite order has been editted"
